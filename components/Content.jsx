                        ...
                        <form action="#!">                         
                                <div className="grid grid-cols-3 gap-6">
                                    <div className=" col-span-6 sm:col-span-4">
                                        <label for="prodName" className="block text-sm font-medium text-gray-700 ">
                                            Name
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className=" col-span-6 sm:col-span-4">
                                        <label for="prodBrand" className="block text-sm font-medium text-gray-700">
                                            Brand
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    {/* Number Inputs  */}
                                    <div className="col-span-6 sm:col-span-4">
                                        <label for="prodCost" className="block text-sm font-medium text-gray-700">
                                            Cost
                                        </label>
                                        <input
                                            type="number"
                                    ...
                                    <div className="col-span-6 sm:col-span-4">
                                        <label for="prodPrice" className="block text-sm font-medium text-gray-700">
                                            Price
                                        </label>
                                        <input
                                            type="number"
                                    ...
                                    <div className="col-span-6 sm:col-span-4">
                                        <label for="prodDiscount" className="block text-sm font-medium text-gray-700">
                                            Discount
                                        </label>
                                        <input
                                            type="number"
                                    ...
                                    <div className="col-span-6 sm:col-span-4">
                                        <label for="prodStock" className="block text-sm font-medium text-gray-700">
                                            Stock
                                        </label>
                                        <input
                                            type="number"
                                    ...
                                    <div className=" col-span-6 sm:col-span-4">
                                        <label for="prodBarcode" className="block text-sm font-medium text-gray-700">
                                            Barcode
                                        </label>
                                        <input
                                            type="text"
